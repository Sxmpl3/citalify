<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        ¡Gracias por registrarte! Antes de empezar, verifica tu dirección de correo electrónico haciendo clic en el enlace que te hemos enviado. Si no lo recibiste, podemos enviarte otro.
    </div>
